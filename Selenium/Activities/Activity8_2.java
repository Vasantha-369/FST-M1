...
public class Activity8_2 {
    public static void main(String[] args) {
        ...
        List<WebElement> colnum = driver.findElements(By.xpath("//table[@id='sortableTable']/thead/tr/th"));
   
        List<WebElement> rownum = driver.findElements(By.xpath("//table[@id='sortableTable']/tbody/tr"));
